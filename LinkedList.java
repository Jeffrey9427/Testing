    ...
    ***********************/
    public static void removeCourse() {
        ...
        //check if first course has matching name
            ...
            if (head != null) {
                head.coursePrevious = null;   //update previous reference of the new head
            }
        ...
        while (currentCourse.courseNext != null && !currentCourse.courseNext.courseName.equals(courseName)) {
        ...
        //if found, remove course from linkedList
        Course courseToRemove = currentCourse.courseNext;
        currentCourse.courseNext = courseToRemove.courseNext;

        if (courseToRemove.courseNext != null) {
            courseToRemove.courseNext.coursePrevious = currentCourse;  //Update next course's previous reference
        }
        System.out.println("\n✅Successfully removed course!");
    }
        ...
        while (currentCourse != null) {
            if (currentCourse.courseId.equals(courseName)) {
                ...
                if (currentCourse.studentListHead == null) {
                    ...
                    newStudent.studentPrevious = lastStudent;
                }
